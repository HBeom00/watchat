        ...
        <div className="embla w-[1060px], h-[360px] relative" ref={emblaRef}>
          ...
          <div className="flex justify-center mt-4 space-x-2">
            {[...Array(slidesInView)].map((_, index) => (
              <button
                key={index}
                className={`w-3 h-3 rounded-full ${index === selectedIndex ? 'bg-blue-500' : 'bg-gray-300'}`}
